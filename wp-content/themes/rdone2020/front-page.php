	...
	<section id="photo" class="p-top-photo is-fade">
		...
		<article class="p-slide-panel">
			...
			<ul class="p-slide-panel__slide js-infiniteslide--left">
				...
				<li><a href="<?php echo get_theme_file_uri( '/images/photo/items/4M3A6482-1024x683.jpg' ); ?>" data-group="gallery" data-modaal-animation="fade" class="gallery"><img src="<?php echo get_theme_file_uri( '/images/photo/items/4M3A6482-150x150.jpg' ); ?>" alt="踏切の写真"></a></li>
				...
				<li><a href="<?php echo get_theme_file_uri( '/images/photo/items/4M3A6505-1024x683.jpg' ); ?>" data-group="gallery" data-modaal-animation="fade" class="gallery"><img src="<?php echo get_theme_file_uri( '/images/photo/items/4M3A6505-150x150.jpg' ); ?>" alt="高架下の写真"></a></li>
