...
<div class="c-frame--dent">
	<div class="c-frame--dent__content">
		...
		吾輩は猫である。吾輩は猫である。吾輩は猫である。吾輩は猫である。吾輩は猫である。吾輩は猫である。吾輩は猫である。
		吾輩は猫である。吾輩は猫である。吾輩は猫である。吾輩は猫である。吾輩は猫である。吾輩は猫である。吾輩は猫である。
		吾輩は猫である。吾輩は猫である。吾輩は猫である。吾輩は猫である。吾輩は猫である。吾輩は猫である。
		吾輩は猫である。吾輩は猫である。吾輩は猫である。吾輩は猫である。吾輩は猫である。吾輩は猫である。吾輩は猫である。吾輩は猫である。吾輩は猫である。
		吾輩は猫である。吾輩は猫である。吾輩は猫である。吾輩は猫である。吾輩は猫である。吾輩は猫である。吾輩は猫である。吾輩は猫である。吾輩は猫である。
		吾輩は猫である。吾輩は猫である。吾輩は猫である。吾輩は猫である。吾輩は猫である。吾輩は猫である。吾輩は猫である。吾輩は猫である。吾輩は猫である。
	</div>
</div>
<br>
<br>
<div class="c-frame--ornament--type-a">
	私は今英語を勉強しています。難しいです。私は今英語を勉強しています。難しいです。私は今英語を勉強しています。難しいです。
	私は今英語を勉強しています。難しいです。私は今英語を勉強しています。難しいです。私は今英語を勉強しています。難しいです。
	私は今英語を勉強しています。難しいです。私は今英語を勉強しています。難しいです。私は今英語を勉強しています。難しいです。
	私は今英語を勉強しています。難しいです。私は今英語を勉強しています。難しいです。私は今英語を勉強しています。難しいです。
</div>
...
<br>
<br>
<div class="c-frame--ornament--type-b">
	エンパイヤーステイトビルディングエンパイヤーステイトビルディングエンパイヤーステイトビルディングエンパイヤーステイトビルディング
	エンパイヤーステイトビルディングエンパイヤーステイトビルディングエンパイヤーステイトビルディングエンパイヤーステイトビルディングエンパイヤーステイトビルディング
	エンパイヤーステイトビルディングエンパイヤーステイトビルディングエンパイヤーステイトビルディングエンパイヤーステイトビルディングエンパイヤーステイトビルディング
	エンパイヤーステイトビルディングエンパイヤーステイトビルディングエンパイヤーステイトビルディングエンパイヤーステイトビルディングエンパイヤーステイトビルディング
</div>
<br><br>
...
<main class="l-main">
	<article class="p-top-article--about">
		<h2 class="p-top-article--about__head">
			...
			<span class="p-top-article--about__head__text c-font--regular">
				Web サイト（ホームページ）などを<br class="u-br--sp">制作している株式会社 Rish です
			</span>
		</h2>
	...
	<article class="p-top-article--advantage">
		<section class="p-top-article--advantage__parallel">
			<figure class="p-img--advantage c-drop-shadow-bg--right" style="width:568px;">
				<img src="<?php echo esc_url( get_theme_file_uri( '/images/top/solvable--alice-rabbit.jpg' ) ); ?>" alt="">
			</figure>
			<div class="">
				<h3 class="c-decoration--rabbit--body">私達が解決できる課題</h3>
				<ul class="c-bg--spade">
					<li>作って終わらない Web サイト・ホームページを作成して欲しい</li>
					<li>ブランディングに必要なロゴ・グラフィック・写真・イラスト作成などお願いしたい</li>
					<li>マーケティングのサポートをして欲しい</li>
					<li>ブログ・メディアのアクセスアップサポートや記事執筆代行をお願いしたい</li>
					<li>自分のプロフィール写真や従業員の写真、会社の写真撮影をお願いしたい</li>
					<li>EC サイトの商品解説ページ作成や写真撮影を依頼したい</li>
					<li>WordPress を使ったサイト運用を手伝って欲しい・機能追加して欲しい</li>
					<li>WordPress のメンテナンスをお願いしたい</li>
					<li>SEO に対する知識を身に着けたい</li>
					<li>特定のキーワードを検索上位に表示したい</li>
				</ul>
			</div>
		</section>
		<section class="">
